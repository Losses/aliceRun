...
export class TimeMagic {
   ...
   constructor(frameRateLimiter: number | null = 60, speed = 1) {
      this.speed = speed;
      ...
      this.maxPhase = frameRateLimiter
         ? Math.floor(1000 / frameRateLimiter) - 1
   ...
   tick(x = -1) {
      ...
      const timestamp =
         this.accumulateTime - this.accumulateTimeWhileWindowHidden;
