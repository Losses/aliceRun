 ...
 */
export function Madgwick(sampleInterval: number, options?: IMadgwickOptions) {
    //---------------------------------------------------------------------------------------------------
    // Definitions
    ...
    function doBruteForceInitialisation(
        ax: number,
        ay: number,
        az?: number,
        mx?: number,
